        ...
        <section class="news-single">
            <div class="news-single__body container">
               ...
               <div class="latest-news latest-news_sm">
						<h4 class="latest-news__title">Recent nieuws</h4>
						<ul class="latest-news__list">
                     <?php 
                     $the_query = new WP_Query( array( 'post_type' => 'post', 'posts_per_page' => 5, 'post__not_in' => array(get_the_ID()) ) );
                     ?>
                     ...
                     <?php endif; ?>
						...
						<a href="<?php get_post_type_archive_link( 'post' ); ?>" class="latest-news__link-more link link_blue">Lees meer nieuws</a>
					</div>
                </div>
            </div>
        </section>
